...
import { Loader2, Send, Check, Instagram, Upload, Calendar, X } from "lucide-react"
...
export function MarketApplicationForm({ isOpen, onClose }: MarketApplicationFormProps) {
    const { user } = useAuth()
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            toast({
                ...
                description: "Başvurunuz başarıyla alındı. Onaylandıktan sonra ödeme bilgileri ile iletişime geçeceğiz.",
            })
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Yılbaşı pazarımızda yer almak için formu doldurun. Ürünlerinizin ve sizin Lokal'in ruhunu yansıtmasını bekliyoruz.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="bg-gradient-to-r from-red-50 to-green-50 dark:from-red-950/30 dark:to-green-950/30 rounded-xl p-4 mb-4">
                    ...
                    <div className="mt-3 pt-3 border-t border-border/50">
                        <p className="text-xs text-muted-foreground">
                            💰 Başvuru onaylandıktan sonra <span className="font-semibold text-red-600">1800₺</span> katılım ücreti için ödeme bilgileri paylaşılacaktır.
                        </p>
                    </div>
                </div>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="https://instagram.com/kullaniciadi" {...field} />
                                    </FormControl>
                                    <p className="text-xs text-muted-foreground">Görsellerinizin bulunduğu Instagram hesabınız</p>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <div className="space-y-3">
                                            ...
                                            <FormControl>
                                                ...
                                                >
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <div className="text-xs text-muted-foreground">Cumartesi</div>
                                                    </div>
                                                    {field.value && <Check className="w-5 h-5 text-red-500" />}
                                                </label>
                                            </FormControl>
                                        </FormItem>
                                    )}
                                            ...
                                            <FormControl>
                                                ...
                                                >
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <div className="text-xs text-muted-foreground">Pazar</div>
                                                    </div>
                                                    {field.value && <Check className="w-5 h-5 text-green-500" />}
                                                </label>
                                            </FormControl>
                                        </FormItem>
                                    )}
                            ...
                            {form.formState.errors.day28 && (
                                <p className="text-sm text-red-500">{form.formState.errors.day28.message}</p>
                            )}
                        </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Ürünlerinizin el emeği, hikayesi, doğallığı, sürdürülebilirliği ve yaratıcı unsurları değerlendirilecektir.
                                    </p>
                                    <FormMessage />
                                </FormItem>
                            )}
